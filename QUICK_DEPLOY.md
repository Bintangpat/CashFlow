...
### API Not Loading?
✅ Check `NEXT_PUBLIC_API_URL` in Vercel includes `/api` at the end
✅ Verify Railway service is running (check health endpoint)

### Database Connection Error?
✅ Ensure Railway PostgreSQL service is running
✅ Run migrations: `railway run pnpm --filter @cashflow/api prisma migrate deploy`
